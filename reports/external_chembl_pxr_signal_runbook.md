...
The current final model is anchored on Suiren/CheMeleon predictions plus guarded
Phase 1 residual calibration. Most additional candidates tested so far were not
independent enough: RDKit descriptors, UniMol/ChemBERTa embeddings, and tree
...
locked Suiren/CheMeleon anchor.
...
Do not replace `submissions/openadmet_pxr_activity_final_submission.csv` unless
...
that Suiren/CheMeleon did not learn from the OpenADMET challenge chemistry. If it
